...
export const experiencesData = [
    ...
    },
    {
        ...
        description:
        [
            "Architected the development of microservices for their e-commerce business, resulting in increased system scalability and a 40% reduction in maintenance costs.",
            "Led the implementation of secured REST endpoints utilizing API versioning, Spring Security, OAuth2, and JWTs leading to a 35% reduction in security vulnerabilities and a 15% increase in overall API security.",
            "Implemented data persistence using Spring Data JPA, Hibernate, along with a distributed caching system Redis, resulting in an 80% increase in system performance and a 90% reduction in response times.",
            "Built Spring Boot scheduled tasks to monitor missing invoices based on set parameters, integrate with notification systems (e.g., email, SMS), for PostNord by initiating 95% of basic claim forms automatically.",
            "Successfully deployed and managed Microservices on AWS, utilizing services such as EC2, S3, Lambda, RDS, IAM, CloudFormation, CloudWatch, Elastic Beanstalk, and SQS improving scalability and reliability.",
            "Utilised Apache Kafka to build a real-time event-driven architecture, enabling the system to handle 1000+ events per second.",
            "Continuous Integration/Deployment Pipeline, pull requests, code reviews, load/stress testing, unit/integration/e2e testing.",
        ],
